...
class Prestamos : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_MostrarPrestamo.isEnabled = false
    ...
    fun Guardar(){
        ...
        }else if(txtFecha2.text.toString().length < 1 || txv_FechaDevolucion.text.toString().length < 1 ){
            txtFecha2.error ="Debe de seleccionar una fecha"
        }else{
